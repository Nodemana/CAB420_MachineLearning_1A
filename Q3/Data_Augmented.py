...
data_augmentation = keras.Sequential([
  ...
  layers.RandomTranslation(height_factor=(-0.01, 0.01), width_factor=(-0.01, 0.01))
])
...
x = layers.Conv2D(filters=8, kernel_size=(3,3), padding='same', activation='relu')(augmented)
